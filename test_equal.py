...
actual = torch.load(f"{dirpath_actual}/base_model.model.model.layers.31.input_layernorm_outepoch2.pt")

#dirpath_original = "/u/area/ddoimo/ddoimo/open/geometric_lens/repo/results/validation/llama-2-7b/0shot"
dirpath_original = "/u/area/ddoimo/ddoimo/open/geometric_lens/repo/results/validation/llama-2-7b/0shot"
expected = torch.load(f"{dirpath_original}/_fsdp_wrapped_module.model.layers.31._fsdp_wrapped_module.input_layernorm_target.pt")
