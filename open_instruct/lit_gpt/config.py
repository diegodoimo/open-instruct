...
# def hidden_dim_func(hidden_dim):
#     x = int(8 * hidden_dim / 3)
#     return find_multiple(x, 256)


# hidden_dim_func(8192)
###############
# Meta LLaMA 1
###############
llama_1 = [
    ...
    dict(
        name="Llama-1-7b-hf",
        hf_config=dict(org="meta-llama", name="Llama-1-7b-hf"),
        vocab_size=32000,
        padding_multiple=64,
        n_layer=32,
        rotary_percentage=1.0,
    ...
    dict(
        name="Llama-1-13b-hf",
        hf_config=dict(org="meta-llama", name="Llama-1-13b-hf"),
        vocab_size=32000,
        padding_multiple=64,
        n_layer=40,
        n_head=40,
    ...
    dict(
        name="Llama-1-30b-hf",
        hf_config=dict(org="meta-llama", name="Llama-1-30b-hf"),
        vocab_size=32000,
        padding_multiple=64,
        n_layer=60,
        n_head=52,
    ...
    dict(
        name="Llama-1-65b-hf",
        hf_config=dict(org="meta-llama", name="Llama-1-65b-hf"),
        vocab_size=32000,
        padding_multiple=64,
        n_layer=80,
        n_head=64,
...
laptop_llama = [
    dict(
        name="laptop_llama",
        hf_config=dict(org="me", name="test"),
        block_size=4096,
        vocab_size=32000,
        padding_multiple=64,
        n_layer=3,
